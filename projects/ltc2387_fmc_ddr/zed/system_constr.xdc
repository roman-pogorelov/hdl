...
set_input_delay -clock dco -max -4.4 [get_ports da_p];
set_input_delay -clock dco -min -4.0 [get_ports da_p];
set_input_delay -clock dco -max -4.4 [get_ports da_n];
set_input_delay -clock dco -min -4.0 [get_ports da_n];
set_input_delay -clock dco -max -4.4 [get_ports db_p];
set_input_delay -clock dco -min -4.0 [get_ports db_p];
set_input_delay -clock dco -max -4.4 [get_ports db_n];
set_input_delay -clock dco -min -4.0 [get_ports db_n];
