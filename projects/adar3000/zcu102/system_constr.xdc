...
set_property  -dict {PACKAGE_PIN  U10  IOSTANDARD LVCMOS18}  [get_ports gpio3]                   ; ## C26  FMC_HPC0_LA27_P
set_property  -dict {PACKAGE_PIN  AC11 IOSTANDARD LVCMOS18}  [get_ports gpio4]                   ; ## H26  FMC_HPC0_LA21_N
